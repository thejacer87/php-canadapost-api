...
use CanadaPost\Entity\RateRequest;
use CanadaPost\Entity\RateResponse;
use CanadaPost\Entity\Shipment;
...
class Rate extends CanadaPost
{
     ...
     * errors in the response back from Canada Post.
     *
     ...
     *
     * @param RateRequest $rateRequest The request details. Refer to the Canada Post documentation for available structure
     *
     * @return string
     */
